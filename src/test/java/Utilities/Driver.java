...
//    chrome ve firefox yukaridaki gibi yazsaydik static oldugu icin ikisini birlikte paralelde kullanamazdik

    // Her farklı browser için farklı bir static değişken havuzu oluşturduk.
    private static ThreadLocal<WebDriver> threadDriver = new ThreadLocal<>();
    //Kontrol merkezi ThreadLocal
...
//    public static String browserType1="Firefox";
    ...
    public static WebDriver getDriver(){
        ...
        // todo Normalde default olarak chrome seciliydi. Fakat basqar bende firefox ile daha iyi calistigi icin onu atadim
        }
    ...
    public static void quitDriver(){
        ...
        if (threadDriver.get() != null){
            threadDriver.get().quit();      // acik kalan browserlari ciktiktan sonra temizle
